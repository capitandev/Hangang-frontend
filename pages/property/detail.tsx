...
import pages from '..';
import { InsertComment, Sort } from '@mui/icons-material';
...
const PropertyDetail: NextPage = ({ initialComment, ...props }: any) => {
	...
	const likePropertyHandler = async(user: T, id: string)=>{
		try{
			...
			//excute likeTargetProperty Mutaion
			await likeTargetProperty ({ variables: {input: id}});
			//excute likeTargetProperty Refetch
	...
	if(getPropertiesLoading){
		return(<Stack sx={{dislay:"flex", justifyContent: "center", alignItems: "center", width: "100%", height:"1080px",}}><CircularProgress size={`1rem`}/></Stack>)
	}
			...
			<div id={'property-detail-page'}>
				<div className={'container'}>
					<Stack className={'property-detail-config'}>
						...
						{setDestinationProperties.length !== 0 && (
